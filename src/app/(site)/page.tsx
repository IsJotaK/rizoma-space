...
export default async function HomePage() {
  ...
  const wa1 = d.redes.find((r) => r.nombre === "whatsapp_1")?.url || `https://wa.me/${d.contacto.whatsapp_1}`;
  const wa2 = d.redes.find((r) => r.nombre === "whatsapp_2")?.url || `https://wa.me/${d.contacto.whatsapp_2}`;
  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="navbar-collapse" id="navbarNav">
            <ul className="navbar-nav">
              ...
              <li>
                <a className="nav-link" href="#certificacion">
                  Certificación
                </a>
              </li>
              <li>
          ...
          <a href={wa1} target="_blank" rel="noopener noreferrer" className="btn btn--whatsapp-header d-none d-lg-inline-flex">
      ...
      <section className="hero-stats-bar">
        <div className="container">
          <div className="hero-stats-bar__grid">
            {d.stats.map((st, i) => (
              <div className="hero-stats-bar__item" key={i}>
                {st.icono ? (
      ...
      <section className="services section--alt" id="servicios">
        <div className="container">
          <div className="section__header text-center">
            <h2 className="section__title">{sectionTitle(d.secciones.servicios?.titulo)}</h2>
            <p className="section__desc">{d.secciones.servicios?.descripcion}</p>
          </div>
          <div className="row g-4 justify-content-center">
            {d.services.map((sv, i) => (
              <div className="col-lg-6" key={i}>
                <div className="service-card h-100 tilt reveal">
      ...
      <section className="certification" id="certificacion">
        <div className="container">
          <div className="section__header text-center">
            <h2 className="section__title">{sectionTitle(d.secciones.certificacion?.titulo || d.certificacion.titulo)}</h2>
            <p className="section__desc">{d.secciones.certificacion?.descripcion || d.certificacion.descripcion}</p>
          </div>
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="certification__card reveal">
                ...
                {d.certificacion.boton_texto && (
                  <a href={d.certificacion.boton_enlace} target="_blank" rel="noopener noreferrer" className="btn btn--primary">
      ...
      <section className="how-it-works" id="como-funciona">
        <div className="container">
          <div className="section__header text-center">
            <h2 className="section__title">{sectionTitle(d.secciones["como-funciona"]?.titulo)}</h2>
            <p className="section__desc">{d.secciones["como-funciona"]?.descripcion}</p>
          </div>
          <div className="steps">
            {d.pasos.map((p, i) => (
      ...
      <section className="gallery section--alt" id="galeria">
        <div className="container">
          <div className="section__header text-center">
            <h2 className="section__title">{sectionTitle(d.secciones.galeria?.titulo)}</h2>
            <p className="section__desc">{d.secciones.galeria?.descripcion}</p>
          </div>
        </div>
            ...
            <div className="gallery__scroll-track" id="galleryTrack">
              {galleryItems.map((g, i) => (
                <a
                  ...
                  className="gallery__scroll-item reveal"
                  key={i}
                >
      ...
      <section className="quote" id="cotizacion">
        <div className="container">
          <div className="section__header text-center">
            <h2 className="section__title">{sectionTitle(d.secciones.cotiza?.titulo)}</h2>
            <p className="section__desc">{d.secciones.cotiza?.descripcion}</p>
          </div>
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="quote__form reveal">
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="form-error" id="phoneError">
                      Debe ingresar 8 dígitos después del +56 9
                    </div>
                  </div>
                  <div className="col-md-6">
                    ...
                    <div className="form-error" id="locationError">
                  ...
                  <div className="col-12">
                    ...
                    <textarea
                      ...
                      id="qmessage"
                      rows={3}
                      placeholder="Ej: volumen estimado, tipo de residuo, dirección exacta..."
                    />
                  </div>
                </div>
      ...
      <section className="coverage section--alt" id="cobertura">
        <div className="container">
          <div className="section__header text-center">
            <h2 className="section__title">{sectionTitle(d.secciones.cobertura?.titulo)}</h2>
            <p className="section__desc">{d.secciones.cobertura?.descripcion}</p>
          </div>
          <div className="coverage__grid">
            {d.zonas.map((z, i) => (
              <div className="coverage__zone reveal" key={i}>
            ...
            <div className="coverage__zone coverage__zone--cta reveal">
              <Icon name="map-pin" />
              <h3>{d.cta.titulo}</h3>
      ...
      <section className="contact" id="contacto">
        <div className="container">
          <div className="section__header text-center">
            <h2 className="section__title">{sectionTitle(d.secciones.contacto?.titulo)}</h2>
            <p className="section__desc">{d.secciones.contacto?.descripcion}</p>
          </div>
      ...
      <div className="thankyou-toast" id="thankyouToast">
        <div className="thankyou-toast__content">
          <div className="thankyou-toast__icon">
            <Icon name="circle-check" />
          </div>
          <h3 className="thankyou-toast__title">¡Cotización enviada!</h3>
          <p className="thankyou-toast__text">
            Gracias por contactarnos. Te responderemos a la brevedad por WhatsApp.
          </p>
          <button className="btn btn--primary btn-sm" id="newQuoteBtn">
            <Icon name="redo" className="icon-sm" /> Nueva cotización
          </button>
        </div>
      </div>
